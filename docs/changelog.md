...
- ⭐👾 Add Fully managed connector custom SMT example [#7946](https://github.com/vdesabou/kafka-docker-playground/issues/7946)
...
- ⭐✨☸️ Run any onprem connector example using Confluent For Kubernetes (CFK) completely transparently using `--environment cfk` CLI option [#7865](https://github.com/vdesabou/kafka-docker-playground/issues/7865)
...
- 🐞 Remove manual installation of JDBC microsoft driver for JDBC examples [#7791](https://github.com/vdesabou/kafka-docker-playground/issues/7791)
...
- 👾 Add FM IBM Source and Sink examples with EOS [#7541](https://github.com/vdesabou/kafka-docker-playground/issues/7541)
...
- 👾 Keep Control-center next gen image up to date [#7323](https://github.com/vdesabou/kafka-docker-playground/issues/7323)
- 🧠⭐ Add --compile option to playground connector-plugin sourcecode [#7321](https://github.com/vdesabou/kafka-docker-playground/issues/7321)
- 👾 Add acknowledgment support test for splunk-s2s-source connector [#7311](https://github.com/vdesabou/kafka-docker-playground/issues/7311)
- 🧠 Add --sensitive-property to playground connector connector-migration-utility migrate [#7307](https://github.com/vdesabou/kafka-docker-playground/issues/7307)
- 👾 Add onprem HTTP sink v2 (confluent employees only) example [#7306](https://github.com/vdesabou/kafka-docker-playground/issues/7306)
- 👾 Add onprem HTTP source v2 (confluent employees only) example [#7305](https://github.com/vdesabou/kafka-docker-playground/issues/7305)
...
- 🐛 Control-center next gen broken with latest version [#7322](https://github.com/vdesabou/kafka-docker-playground/issues/7322)
- 🐛 connect/connect-jms-solace-sink false positive [#7291](https://github.com/vdesabou/kafka-docker-playground/issues/7291)
- 🧠 Show skipped test when playground test is run instead of failure [#7289](https://github.com/vdesabou/kafka-docker-playground/issues/7289)
- 🐛 Tests may fail when run in parallel due to shared resources [#7286](https://github.com/vdesabou/kafka-docker-playground/issues/7286)
...
- 👾 Add redis UI to all redis examples using redis insignt [#7096](https://github.com/vdesabou/kafka-docker-playground/issues/7096)
- 👾⭐ Add fully-managed Redis Kafka Source connector example [#7095](https://github.com/vdesabou/kafka-docker-playground/issues/7095)
- 👾⭐ Add fully-managed Redis Kafka Sink connector example [#7093](https://github.com/vdesabou/kafka-docker-playground/issues/7093)
- 👾 Add config-<connector_class>.txt and config-<connector_class>.json in each connect example folder [#7033](https://github.com/vdesabou/kafka-docker-playground/issues/7033)
- 👾 Add AWSLambdaBasicExecutionRole policy in lambda sink examples to be able to view logging in Cloudwatch [#7026](https://github.com/vdesabou/kafka-docker-playground/issues/7026)
- 👾 Upgrade custom connector Apache Iceberg example to latest version [#7024](https://github.com/vdesabou/kafka-docker-playground/issues/7024)
...
- 🐛 playground topic display-consumer-offsets  is broken [#7054](https://github.com/vdesabou/kafka-docker-playground/issues/7054)
- 🐛 connector zip option is broken when used with menu [#7025](https://github.com/vdesabou/kafka-docker-playground/issues/7025)
