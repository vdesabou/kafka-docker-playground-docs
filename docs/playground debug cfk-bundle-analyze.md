# playground debug cfk-bundle-analyze
...
```bash
playground debug cfk-bundle-analyze [OPTIONS]
```
...
```bash
playground debug cfk-bundle-analyze --bundle ./extracted-bundle/
```

```bash
playground debug cfk-bundle-analyze --bundle ./bundle.zip --severity high
```
...
```bash
playground debug cfk-bundle-analyze -b ./bundle.tgz --html
```

```bash
playground debug cfk-bundle-analyze -b ./bundle.tgz --html --output-dir ./reports
```
